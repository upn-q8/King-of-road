...
//       <button
//         className="flex items-center text-[#2a2a2a] font-semibold text-lg"
//         onClick={close}
//       >
//         ← Back to Products
//       </button>
...
//                 </p>
//                 <p className="text-[#7F7F7F] text-lg font-normal">{data?.name_En}</p>
//               </div>
//               <div>
//                 <p className="font-medium text-[#2a2a2a] flex items-center">
//                   <img src="/dashboard/dot.svg" className="mr-2" /> Product Code
//                 </p>
//                 <p className="text-[#7F7F7F] text-lg font-normal">{data?.code}</p>
//               </div>
//               <div>
//                 <p className="font-medium text-[#2a2a2a] flex items-center">
//                   <img src="/dashboard/dot.svg" className="mr-2" /> Price
//                 </p>
//                 <p className="text-[#7F7F7F] text-lg font-normal">{data?.quantities?.[0]?.price} KWD</p>
//               </div>
//             </div>
...
//                   <img key={i} src="/home/car1.png" className="w-44 h-44 object-cover rounded-lg shadow-md border" />
//                 ))}
//               </div>
//             </div>
...
//               </p>
//               <p className="text-[#7F7F7F] text-lg font-normal leading-relaxed">{data?.description}</p>
//             </div>

           
//             <div className="mt-6">
//               <p className="font-medium text-[#2a2a2a] flex items-center">
//                 <img src="/dashboard/dot.svg" className="mr-2" /> Product Weight
//               </p>
//               <p className="text-[#7F7F7F] text-lg font-normal">{data?.weight || "N/A"}</p>
//             </div>
...
//                   <p className="text-[#7F7F7F] text-lg font-normal">{feature.description}</p>
//                 </div>
//               ))}
//             </div>
//           </>
...
//   return product ? <ProductDetails data={product} /> : <p>Loading...</p>;
// }
